                ...
                <div class="card shadow h-100">
                    <div class="card-header border-0">
                        <div class="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between text-center text-md-left">
                            <div class="mb-3">
                                <h2 class="mb-0">Tambah Aparat</h2>
                ...
                <form autocomplete="off" action="{{ route('pemerintahan-desa.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" onkeypress="return hanyaAngka(event)" class="form-control @error('nip') is-invalid @enderror" name="nip" placeholder="Masukkan NIP ..." value="{{ old('nip') }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" onkeypress="return hanyaAngka(event)" class="form-control @error('nipd') is-invalid @enderror" name="nipd" placeholder="Masukkan NIPD ..." value="{{ old('nipd') }}">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control @error('nomor_sk_pemberhentian') is-invalid @enderror" name="nomor_sk_pemberhentian" id="nomor_sk_pemberhentian" placeholder="Masukkan Nomor SK Pemberhentian  ..." value="{{ old('nomor_sk_pemberhentian') }}">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" class="form-control @error('tanggal_sk_pemberhentian') is-invalid @enderror" name="tanggal_sk_pemberhentian" id="tanggal_sk_pemberhentian" placeholder="Masukkan Tanggal SK Pemberhentian ..." value="{{ old('tanggal_sk_pemberhentian') }}">
