                ...
                <div class="card shadow h-100">
                    <div class="card-header border-0">
                        <div class="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between text-center text-md-left">
                            <div class="mb-3">
                                <h2 class="mb-0">Edit Bantuan</h2>
                                <p class="mb-0 text-sm">Kelola Bantuan</p>
                            </div>
                            <div class="mb-3">
                                <a href="{{ route("bantuan.index") }}" class="btn btn-success" title="Kembali"><i class="fas fa-arrow-left"></i> Kembali</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="card bg-secondary shadow h-100">
    <div class="card-body">
        <form autocomplete="off" action="{{ route('bantuan.update', $bantuan) }}" method="post" enctype="multipart/form-data">
            @csrf @method('patch')
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <select class="form-control @error('sasaran_program') is-invalid @enderror" name="sasaran_program" id="sasaran_program">
                        ...
                        <option value="1" {{ old('sasaran_program', $bantuan->sasaran_program) == 1 ? 'selected' : '' }}>Penduduk</option>
                        <option value="2" {{ old('sasaran_program', $bantuan->sasaran_program) == 2 ? 'selected' : '' }}>Keluarga</option>
                    </select>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input type="text" class="form-control @error('nama_program') is-invalid @enderror" name="nama_program" placeholder="Masukkan Nama Program ..." value="{{ old('nama_program', $bantuan->nama_program) }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <textarea class="form-control @error('keterangan') is-invalid @enderror" name="keterangan" placeholder="Masukkan Keterangan ...">{{ old('keterangan', $bantuan->keterangan) }}</textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <select class="form-control @error('asal_dana') is-invalid @enderror" name="asal_dana" id="asal_dana">
                        ...
                        <option value="Pusat" {{ old('asal_dana', $bantuan->asal_dana) == 'Pusat' ? 'selected' : '' }}>Pusat</option>
                        <option value="Provinsi" {{ old('asal_dana', $bantuan->asal_dana) == 'Provinsi' ? 'selected' : '' }}>Provinsi</option>
                        <option value="Kabupaten/Kota" {{ old('asal_dana', $bantuan->asal_dana) == 'Kabupaten/Kota' ? 'selected' : '' }}>Kabupaten/Kota</option>
                        <option value="Dana Desa" {{ old('asal_dana', $bantuan->asal_dana) == 'Dana Desa' ? 'selected' : '' }}>Dana Desa</option>
                        <option value="Lain-lain (Hibah)" {{ old('asal_dana', $bantuan->asal_dana) == 'Lain-lain (Hibah)' ? 'selected' : '' }}>Lain-lain (Hibah)</option>
                    </select>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input type="date" class="form-control @error('tanggal_mulai') is-invalid @enderror" name="tanggal_mulai" placeholder="Masukkan Tanggal Mulai ..." value="{{ old('tanggal_mulai', $bantuan->tanggal_mulai) }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input type="date" class="form-control @error('tanggal_berakhir') is-invalid @enderror" name="tanggal_berakhir" placeholder="Masukkan Tanggal Berakhir ..." value="{{ old('tanggal_berakhir', $bantuan->tanggal_berakhir) }}">
