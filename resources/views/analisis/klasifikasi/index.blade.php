    ...
    <div class="card-header">
        <div class="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between text-center text-md-left">
            ...
            <div class="mb-1">
                ...
                <a href="{{ route('klasifikasi.create', $analisis) }}" class="btn btn-sm btn-primary" title="Tambah" data-toggle="tooltip"><i class="fas fa-plus"></i></a>
            </div>
        </div>
    </div>
    <div class="card-body">
                ...
                <tbody>
                    @forelse ($klasifikasi as $item)
                        <tr>
                            ...
                            <td style="vertical-align: middle">
                                <a href="{{ route('klasifikasi.edit', ['klasifikasi' => $item, 'analisis' => $analisis]) }}" class="btn btn-sm btn-success" data-toggle="tooltip" title="Edit"><i class="fas fa-edit"></i></a>
        ...
        <div class="modal-content bg-gradient-danger">
            ...
            <div class="modal-body">
                ...
                <div class="py-3 text-center">
                    ...
                    <p>Menghapus klasifikasi akan menghapus semua data yang dimilikinya</p>
