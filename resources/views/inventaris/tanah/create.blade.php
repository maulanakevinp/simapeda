                ...
                <div class="card shadow h-100">
                    <div class="card-header border-0">
                        <div class="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between text-center text-md-left">
                            <div class="mb-3">
                                <h2 class="mb-0">Tambah Tanah</h2>
                                <p class="mb-0 text-sm">Kelola Inventaris</p>
                            </div>
                            <div class="mb-3">
                                <a href="{{ route("tanah.index") }}" class="btn btn-success" title="Kembali"><i class="fas fa-arrow-left"></i> Kembali</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="card bg-secondary shadow h-100">
    <div class="card-body">
        <form autocomplete="off" action="{{ route('tanah.store') }}" method="post">
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input type="number" class="form-control" name="luas_tanah" id="luas_tanah" placeholder="Masukkan Luas Tanah ...">
                </div>
            </div>
            <div class="form-group row">
                <label class="form-control-label col-form-label col-md-3" for="tahun_pengadaan">Tahun Pengadaan</label>
                <div class="col-md-9">
                    <input type="number" class="form-control" name="tahun_pengadaan" id="tahun_pengadaan" placeholder="Masukkan Tahun Pengadaan ..." value="{{ date('Y') }}">
                </div>
            </div>
            <div class="form-group row">
                <label class="form-control-label col-form-label col-md-3" for="letak_atau_alamat">Letak/Alamat</label>
                <div class="col-md-9">
                    <textarea class="form-control" name="letak_atau_alamat" id="letak_atau_alamat" placeholder="Masukkan Letak/Alamat ..."></textarea>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <select class="form-control" name="hak_tanah" id="hak_tanah">
                        ...
                        <option value="Hak Pengelola">Hak Pengelola</option>
                    </select>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input class="form-control" name="tanggal_sertifikat" id="tanggal_sertifikat" type="date" placeholder="Tanggal Sertifikat" />
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-3 form-control-label col-form-label" style="text-align:left;" for="nomor_sertifikat">Nomor Sertifikat </label>
                <div class="col-sm-9">
                    <input class="form-control" name="nomor_sertifikat" id="nomor_sertifikat" type="text" placeholder="Nomor Sertifikat"/>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-3 form-control-label col-form-label" style="text-align:left;" for="penggunaan">Penggunaan </label>
                <div class="col-sm-9">
