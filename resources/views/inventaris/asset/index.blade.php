...
@section('title', 'Asset Tetap Lainnya')
                ...
                <div class="card shadow h-100">
                    <div class="card-header border-0">
                        <div class="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between text-center text-md-left">
                            <div class="mb-3">
                                <h2 class="mb-0">Asset Tetap Lainnya</h2>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="dropdown mb-2">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item active" href="{{ route('asset.index') }}">Daftar Inventaris</a>
                                        <a class="dropdown-item" href="{{ route('asset.mutasi') }}">Mutasi Inventaris</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class="card shadow">
    <div class="card-header">
        <div class="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between text-center text-md-left">
            ...
            <div class="mb-1">
                ...
                <a href="{{ route('asset.create') }}?page={{ request('page') }}" class="btn btn-sm btn-primary" title="Tambah" data-toggle="tooltip"><i class="fas fa-plus"></i></a>
                @if (count($asset) > 0)
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-hover table-sm table-striped table-bordered">
                <thead>
                    <tr>
                        ...
                        <th style="vertical-align: middle; text-align: center">Tahun Pengadaan</th>
                        <th style="vertical-align: middle; text-align: center">Asal Usul</th>
                    ...
                    @forelse ($asset as $item)
                        <tr>
                            <td style="vertical-align: middle">
                                <input type="checkbox" class="asset-checkbox" id="delete{{ $item->id }}" name="delete[]" value="{{ $item->id }}">
                            </td>
                            <td style="vertical-align: middle" class="text-center">{{ ($asset->currentpage()-1) * $asset->perpage() + $loop->index + 1 }}</td>
                            <td style="vertical-align: middle">
                                <a href="{{ route('asset.mutasi.edit',$item) }}" class="btn btn-sm btn-primary" data-toggle="tooltip" title="Mutasi"><i class="fas fa-external-link-alt"></i></a>
                                <a href="{{ route('asset.show',$item) }}?page={{ request('page') }}" class="btn btn-sm btn-info" data-toggle="tooltip" title="Detail"><i class="fas fa-eye"></i></a>
                                <a href="{{ route('asset.edit',$item) }}?page={{ request('page') }}" class="btn btn-sm btn-success" data-toggle="tooltip" title="Edit"><i class="fas fa-edit"></i></a>
                                <a class="btn btn-sm btn-danger hapus-data" data-nama="{{ $item->nama_barang }}" data-action="{{ route("asset.destroy", $item) }}" data-toggle="tooltip" title="Hapus" href="#modal-hapus"><i class="fas fa-trash"></i></a>
                            </td>
            ...
            {{ $asset->links('layouts.components.pagination') }}
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-danger modal-dialog-centered modal-" role="document">
        <div class="modal-content bg-gradient-danger">
            ...
            <div class="modal-header">
                <h6 class="modal-title" id="modal-title-delete">Hapus Asset Tetap Lainnya?</h6>
            ...
            <div class="modal-body">
                ...
                <div class="py-3 text-center">
                    ...
                    <p>Menghapus asset akan menghapus semua data yang dimilikinya</p>
        ...
        $(document).on('click', '#delete', function(){
            ...
            if (confirm("Apakah anda yakin ingin menghapus data ini?")) {
                ...
                if (id.length > 0) {
                    ...
                    alertFail('Harap pilih salah satu asset');
                }
            }
        });
