                            ...
                            <div class="mb-3">
                                ...
                                <div class="dropdown mb-2">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item " href="{{ route('peralatan.index') }}">Daftar Inventaris</a>
                                        <a class="dropdown-item active" href="{{ route('peralatan.mutasi') }}">Mutasi Inventaris</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <tbody>
                    @forelse ($peralatan as $item)
                        <tr>
                            ...
                            <td style="vertical-align: middle">
                                <a href="{{ route('peralatan.mutasi.edit', $item) }}?page={{ request('page') }}" class="btn btn-sm btn-success" data-toggle="tooltip" title="Edit"><i class="fas fa-edit"></i></a>
