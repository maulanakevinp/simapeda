...
@section('title', 'Tambah Gedung Dan Bangunan')
                ...
                <div class="card shadow h-100">
                    <div class="card-header border-0">
                        <div class="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between text-center text-md-left">
                            <div class="mb-3">
                                <h2 class="mb-0">Tambah Gedung Dan Bangunan</h2>
                                <p class="mb-0 text-sm">Kelola Inventaris</p>
                            </div>
                            <div class="mb-3">
                                <a href="{{ route("gedung.index") }}" class="btn btn-success" title="Kembali"><i class="fas fa-arrow-left"></i> Kembali</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="card bg-secondary shadow h-100">
    <div class="card-body">
        <form autocomplete="off" action="{{ route('gedung.store') }}" method="post">
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input class="form-control" id="luas_bangunan" name="luas_bangunan" type="number" placeholder="Masukkan Luas Bangunan ..."/>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input class="form-control" id="luas_tanah" name="luas_tanah" type="number" placeholder="Masukkan Luas Tanah ..."/>
                </div>
            </div>
            <div class="form-group row">
