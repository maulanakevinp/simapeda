                ...
                <div class="card shadow h-100">
                    <div class="card-header border-0">
                        <div class="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between text-center text-md-left">
                            <div class="mb-3">
                                <h2 class="mb-0">Tambah Peserta Bantuan</h2>
...
<div class="card bg-secondary shadow h-100">
    <div class="card-body">
        <form autocomplete="off" action="{{ route('bantuan-penduduk.store') }}" method="post" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control @error('nomor_kartu_peserta') is-invalid @enderror" name="nomor_kartu_peserta" id="nomor_kartu_peserta" placeholder="Masukkan Nomor Kartu Peserta ..." value="{{ old('nomor_kartu_peserta') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="file" class="form-control @error('gambar_kartu_peserta') is-invalid @enderror" name="gambar_kartu_peserta" id="gambar_kartu_peserta" placeholder="Masukkan Gambar Kartu Peserta ..." value="{{ old('gambar_kartu_peserta') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control @error('nik') is-invalid @enderror" name="nik" id="nik" placeholder="Masukkan NIK ..." value="{{ old('nik') }}">
