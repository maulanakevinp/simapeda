...
<div class="card bg-secondary shadow h-100">
    <div class="card-body">
        <form autocomplete="off" action="{{ route('surat-masuk.update', $surat_masuk) }}" method="post" enctype="multipart/form-data">
            @csrf @method('patch')
            <div class="form-group row">
                <label class="form-control-label col-form-label col-md-3" for="nomor_urut">Nomor Urut</label>
                <div class="col-md-9">
                    <input type="text" class="form-control @error('nomor_urut') is-invalid @enderror" name="nomor_urut" placeholder="Masukkan Nomor Urut ..." value="{{ old('nomor_urut', $surat_masuk->nomor_urut) }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input type="date" class="form-control @error('tanggal_penerimaan') is-invalid @enderror" name="tanggal_penerimaan" placeholder="Masukkan Tanggal Penerimaan ..." value="{{ old('tanggal_penerimaan', $surat_masuk->tanggal_penerimaan) }}">
                    @error('tanggal_penerimaan')<span class="invalid-feedback font-weight-bold">{{ $message }}</span>@enderror
                </div>
            </div>
            <div class="form-group row">
                <label class="form-control-label col-form-label col-md-3" for="berkas">Berkas Scan Surat Masuk <a target="_blank" href="{{ url(Storage::url($surat_masuk->berkas)) }}" title="Download"><i class="fas fa-download"></i></a></label>
                <div class="col-md-9">
                    <input type="file" accept=".pdf" class="form-control @error('berkas') is-invalid @enderror" name="berkas" placeholder="Masukkan Berkas Scan Surat Masuk ...">
                ...
                <div class="col-md-9">
                    <select class="form-control @error('kode_surat_id') is-invalid @enderror" name="kode_surat_id" id="kode_surat_id">
                        ...
                        @foreach ($kode_surat as $item)
                            <option value="{{ $item->id }}" {{ old('kode_surat_id', $surat_masuk->kode_surat_id) == $item->id ? 'selected' : '' }}>{{ $item->kode }} - {{ $item->nama }} {{ $item->uraian != '-' ? '- '. $item->uraian : ''}}</option>
                        @endforeach
                    </select>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input type="text" class="form-control @error('nomor_surat') is-invalid @enderror" name="nomor_surat" placeholder="Masukkan Nomor Surat ..." value="{{ old('nomor_surat', $surat_masuk->nomor_surat) }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input type="date" class="form-control @error('tanggal_surat') is-invalid @enderror" name="tanggal_surat" placeholder="Masukkan Tanggal Surat ..." value="{{ old('tanggal_surat', $surat_masuk->tanggal_surat) }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input type="text" class="form-control @error('pengirim') is-invalid @enderror" name="pengirim" placeholder="Masukkan Pengirim ..." value="{{ old('pengirim', $surat_masuk->pengirim) }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input type="text" class="form-control @error('isi_singkat_atau_perihal') is-invalid @enderror" name="isi_singkat_atau_perihal" placeholder="Masukkan Isi Singkat/Perihal ..." value="{{ old('isi_singkat_atau_perihal', $surat_masuk->isi_singkat_atau_perihal) }}">
                ...
                <div class="col-md-9">
                    <select multiple class="form-control @error('pemerintahan_desa_id') is-invalid @enderror" name="pemerintahan_desa_id[]" id="pemerintahan_desa_id">
                        @foreach ($pemerintahan_desa as $item)
                            <option value="{{ $item->id }}" {{ old('pemerintahan_desa_id', $surat_masuk->pemerintahan_desa_id) == $item->id ? 'selected' : '' }}>{{ $item->nama }} ({{ $item->jabatan }})</option>
                        @endforeach
                    </select>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input type="text" class="form-control @error('isi_disposisi') is-invalid @enderror" name="isi_disposisi" placeholder="Masukkan Isi Disposisi ..." value="{{ old('isi_disposisi', $surat_masuk->isi_disposisi) }}">
