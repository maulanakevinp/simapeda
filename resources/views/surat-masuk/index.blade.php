                    ...
                    <div class="card-header border-0">
                        <div class="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between text-center text-md-left">
                            ...
                            <div class="mb-3">
                                ...
                                @endif
                                <a href="{{ route('surat-masuk.create') }}?page={{ request('page') }}" class="btn btn-success" title="Tambah" data-toggle="tooltip"><i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <tbody>
                    @forelse ($surat_masuk as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('surat-masuk.edit', $item) }}?page={{ request('page') }}" class="btn btn-sm btn-success" data-toggle="tooltip" title="Edit"><i class="fas fa-edit"></i></a>
                                @if ($item->berkas)
...
@include('layouts.components.hapus', ['nama_hapus' => 'surat masuk'])
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body pt-0">
                <form action="{{ route("surat-masuk.print") }}" method="POST" >
                    @csrf
