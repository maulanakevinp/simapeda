    ...
    <div class="card-body">
        <form autocomplete="off" action="{{ route('surat-masuk.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input type="text" class="form-control @error('nomor_urut') is-invalid @enderror" name="nomor_urut" placeholder="Masukkan Nomor Urut ..." value="{{ old('nomor_urut', $desa->penomoran_surat == 1 ? $desa->nomor_surat_masuk : $desa->nomor_surat) }}">
