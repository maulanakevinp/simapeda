                ...
                <div class="card shadow h-100">
                    <div class="card-header border-0">
                        <div class="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between text-center text-md-left">
                            <div class="mb-3">
                                <h2 class="mb-0">Tambah SK Kades</h2>
                                <p class="mb-0 text-sm">Kelola SK Kades</p>
                            </div>
                            <div class="mb-3">
                                <a href="{{ route("sk-kades.index") }}" class="btn btn-success" title="Kembali"><i class="fas fa-arrow-left"></i> Kembali</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="card bg-secondary shadow h-100">
    <div class="card-body">
        <form autocomplete="off" action="{{ route('sk-kades.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group row">
                <label class="form-control-label col-form-label col-md-3" for="dokumen">Dokumen</label>
                <div class="col-md-9">
                    <input type="file" accept=".pdf,.png,.jpg,.jpeg,.doc,.docx,.xls,.xlsx" class="form-control @error('dokumen') is-invalid @enderror" name="dokumen" placeholder="Masukkan Dokumen ..." value="{{ old('dokumen') }}">
