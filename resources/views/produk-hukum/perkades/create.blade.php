                ...
                <div class="card shadow h-100">
                    <div class="card-header border-0">
                        <div class="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between text-center text-md-left">
                            <div class="mb-3">
                                <h2 class="mb-0">Tambah Perkades</h2>
...
<div class="card bg-secondary shadow h-100">
    <div class="card-body">
        <form autocomplete="off" action="{{ route('perkades.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control @error('nomor_keputusan_kades') is-invalid @enderror" name="nomor_keputusan_kades" placeholder="Masukkan Nomor Keputusan Kades ..." value="{{ old('nomor_keputusan_kades') }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-8">
                    <input type="date" class="form-control @error('tanggal_keputusan_kades') is-invalid @enderror" name="tanggal_keputusan_kades" placeholder="Masukkan Tanggal Keputusan Kades ..." value="{{ old('tanggal_keputusan_kades') }}">
