...
@section('title', 'Tambah Peserta Grup')
                ...
                <div class="card shadow h-100">
                    <div class="card-header border-0">
                        <div class="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between text-center text-md-left">
                            <div class="mb-3">
                                <h2 class="mb-0">Tambah Peserta Grup</h2>
                                <p class="mb-0 text-sm">Kelola Grup</p>
                            </div>
                            <div class="mb-3">
                                <a href="{{ route("grup-penduduk.index", $grup) }}" class="btn btn-success" title="Kembali"><i class="fas fa-arrow-left"></i> Kembali</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="card bg-secondary shadow h-100">
    <div class="card-body">
        <form autocomplete="off" action="{{ route('grup-penduduk.store') }}" method="post" enctype="multipart/form-data">
            @csrf
                        ...
                        <table class="table table-sm">
                            ...
                            <tr>
                                ...
                                <td style="padding:0.5rem;">
                                    <textarea type="text" class="form-control @error('keterangan') is-invalid @enderror" name="keterangan" id="keterangan" placeholder="Masukkan Keterangan">{{ old('keterangan') }}</textarea>
