...
<div class="row">
    <div class="col">
        <div class="card bg-secondary shadow h-100">
            <div class="card-body">
                <form autocomplete="off" action="{{ route('penduduk.update', $penduduk) }}" method="post" enctype="multipart/form-data">
                    @csrf @method('patch')
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="form-group text-center">
                                <label class="form-control-label" for="nik">Foto Penduduk</label> <br>
                                <img onclick="$(this).siblings('.images').click()" class="mw-100 upload-image" style="max-height: 300px" src="{{ $penduduk->foto ? asset(Storage::url($penduduk->foto)) : asset('storage/upload.jpg') }}" alt="foto">
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-6">
                                        ...
                                        <select class="form-control @error('ktp_elektronik') is-invalid @enderror" name="ktp_elektronik" id="ktp_elektronik">
                                            ...
                                            <option value="2" {{ old('ktp_elektronik', $penduduk->ktp_elektronik) == 2 ? 'selected="true"' : ''  }}>KTP-EL</option>
                                        </select>
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <select class="form-control @error('status_rekam_id') is-invalid @enderror" name="status_rekam_id" id="status_rekam_id">
                                            ...
                                            @foreach ($status_rekam as $item)
                                                <option value="{{ $item->id }}" {{ old('status_rekam_id', $penduduk->status_rekam_id) == $item->id ? 'selected="true"' : ''  }}>{{ $item->nama }}</option>
                                            @endforeach
                                        </select>
                    ...
                    <div class="row">
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" onkeypress="return hanyaAngka(event)" class="form-control @error('kk') is-invalid @enderror" name="kk" placeholder="Masukkan Nomor KK ..." value="{{ old('kk', $penduduk->kk) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <select class="form-control @error('status_penduduk_id') is-invalid @enderror" name="status_penduduk_id" id="status_penduduk_id">
                                ...
                                @foreach ($status_penduduk as $item)
                                    <option value="{{ $item->id }}" {{ old('status_penduduk_id', $penduduk->status_penduduk_id) == $item->id ? 'selected="true"' : ''  }}>{{ $item->nama }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="pl-4">
                        <div class="row">
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                <input type="text" class="form-control @error('nomor_akta_kelahiran') is-invalid @enderror" name="nomor_akta_kelahiran" placeholder="Masukkan Nomor Akta Keluarga ..." value="{{ old('nomor_akta_kelahiran', $penduduk->nomor_akta_kelahiran) }}">
                            ...
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                <input type="time" class="form-control @error('waktu_kelahiran') is-invalid @enderror" name="waktu_kelahiran" placeholder="Masukkan Tanggal Lahir ..." value="{{ old('waktu_kelahiran', $penduduk->waktu_kelahiran) }}">
                            ...
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                <select class="form-control @error('tempat_dilahirkan_id') is-invalid @enderror" name="tempat_dilahirkan_id" id="tempat_dilahirkan_id">
                                    ...
                                    @foreach ($tempat_dilahirkan as $item)
                                        <option value="{{ $item->id }}" {{ old('tempat_dilahirkan_id', $penduduk->tempat_dilahirkan_id) == $item->id ? 'selected="true"' : ''  }}>{{ $item->nama }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                <select class="form-control @error('jenis_kelahiran_id') is-invalid @enderror" name="jenis_kelahiran_id" id="jenis_kelahiran_id">
                                    ...
                                    @foreach ($jenis_kelahiran as $item)
                                        <option value="{{ $item->id }}" {{ old('jenis_kelahiran_id', $penduduk->jenis_kelahiran_id) == $item->id ? 'selected="true"' : ''  }}>{{ $item->nama }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                <input type="number" onkeypress="return hanyaAngka(event)" class="form-control @error('anak_ke') is-invalid @enderror" name="anak_ke" placeholder="Masukkan Anak Ke ..." value="{{ old('anak_ke', $penduduk->anak_ke) }}">
                            ...
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                <select class="form-control @error('penolong_kelahiran_id') is-invalid @enderror" name="penolong_kelahiran_id" id="penolong_kelahiran_id">
                                    ...
                                    @foreach ($penolong_kelahiran as $item)
                                        <option value="{{ $item->id }}" {{ old('penolong_kelahiran_id', $penduduk->penolong_kelahiran_id) == $item->id ? 'selected="true"' : ''  }}>{{ $item->nama }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                <input type="number" onkeypress="return hanyaAngka(event)" class="form-control @error('berat_lahir') is-invalid @enderror" name="berat_lahir" placeholder="Masukkan Berat Lahir ..." value="{{ old('berat_lahir', $penduduk->berat_lahir) }}">
                            ...
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                <input type="number" onkeypress="return hanyaAngka(event)" class="form-control @error('panjang_lahir') is-invalid @enderror" name="panjang_lahir" placeholder="Masukkan Panjang Lahir ..." value="{{ old('panjang_lahir', $penduduk->panjang_lahir) }}">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                <select class="form-control @error('kewarganegaraan') is-invalid @enderror" name="kewarganegaraan" id="kewarganegaraan">
                                    ...
                                    <option value="1" {{ old('kewarganegaraan', $penduduk->kewarganegaraan) == 1 ? 'selected="true"' : ''  }}>WNI</option>
                                    <option value="2" {{ old('kewarganegaraan', $penduduk->kewarganegaraan) == 2 ? 'selected="true"' : ''  }}>WNA</option>
                                    <option value="3" {{ old('kewarganegaraan', $penduduk->kewarganegaraan) == 3 ? 'selected="true"' : ''  }}>Dua Kewarganegaraan</option>
                                </select>
                            ...
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                <input type="date" class="form-control @error('tgl_berakhir_paspor') is-invalid @enderror" name="tgl_berakhir_paspor" placeholder="Masukkan Tgl Berakhir Paspor ..." value="{{ old('tgl_berakhir_paspor', $penduduk->tgl_berakhir_paspor) }}">
                    ...
                    <div class="pl-4">
                        <div class="row">
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                <input type="text" onkeypress="return hanyaAngka(event)" class="form-control @error('nik_ayah') is-invalid @enderror" name="nik_ayah" placeholder="Masukkan NIK Ayah ..." value="{{ old('nik_ayah', $penduduk->nik_ayah) }}">
                            ...
                            <div class="form-group col-lg-8 col-md-6">
                                ...
                                <input type="text" class="form-control @error('nama_ayah') is-invalid @enderror" name="nama_ayah" placeholder="Masukkan Nama Ayah ..." value="{{ old('nama_ayah', $penduduk->nama_ayah) }}">
                            ...
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                <input type="text" onkeypress="return hanyaAngka(event)" class="form-control @error('nik_ibu') is-invalid @enderror" name="nik_ibu" placeholder="Masukkan NIK Ibu ..." value="{{ old('nik_ibu', $penduduk->nik_ibu) }}">
                            ...
                            <div class="form-group col-lg-8 col-md-6">
                                ...
                                <input type="text" class="form-control @error('nama_ibu') is-invalid @enderror" name="nama_ibu" placeholder="Masukkan Nama Ibu ..." value="{{ old('nama_ibu', $penduduk->nama_ibu) }}">
                    ...
                    <div class="pl-4">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control @error('nomor_telepon') is-invalid @enderror" name="nomor_telepon" placeholder="Masukkan Nomor Telepon ..." value="{{ old('nomor_telepon', $penduduk->nomor_telepon) }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="email" class="form-control @error('alamat_email') is-invalid @enderror" name="alamat_email" placeholder="Masukkan Alamat Email ..." value="{{ old('alamat_email', $penduduk->alamat_email) }}">
                            ...
                            <div class="form-group col-12">
                                ...
                                <textarea class="form-control @error('alamat_sebelumnya') is-invalid @enderror" name="alamat_sebelumnya" id="alamat_sebelumnya" placeholder="Masukkan Alamat Sebelumnya ...">{{ old('alamat_sebelumnya', $penduduk->alamat_sebelumnya) }}</textarea>
                            ...
                            <div class="form-group col-12">
                                ...
                                <textarea class="form-control @error('alamat_sekarang') is-invalid @enderror" name="alamat_sekarang" id="alamat_sekarang" placeholder="Masukkan Alamat Sekarang ...">{{ old('alamat_sekarang', $penduduk->alamat_sekarang) }}</textarea>
                    ...
                    <div class="pl-4">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                <input type="text" class="form-control @error('nomor_akta_perkawinan') is-invalid @enderror" name="nomor_akta_perkawinan" id="nomor_akta_perkawinan" placeholder="Masukkan Nomor Akta Perkawinan ..." value="{{ old('nomor_akta_perkawinan', $penduduk->nomor_akta_perkawinan) }}">
                            ...
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                <input type="date" class="form-control @error('tanggal_perkawinan') is-invalid @enderror" name="tanggal_perkawinan" id="tanggal_perkawinan" placeholder="Masukkan tanggal_perkawinan ..." value="{{ old('tanggal_perkawinan', $penduduk->tanggal_perkawinan) }}">
                            ...
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                <select class="form-control @error('jenis_cacat_id') is-invalid @enderror" name="jenis_cacat_id" id="jenis_cacat_id">
                                    ...
                                    @foreach ($jenis_cacat as $item)
                                        <option value="{{ $item->id }}" {{ old('jenis_cacat_id', $penduduk->jenis_cacat_id) == $item->id ? 'selected="true"' : ''  }}>{{ $item->nama }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                <select class="form-control @error('sakit_menahun_id') is-invalid @enderror" name="sakit_menahun_id" id="sakit_menahun_id">
                                    ...
                                    @foreach ($sakit_menahun as $item)
                                        <option value="{{ $item->id }}" {{ old('sakit_menahun_id', $penduduk->sakit_menahun_id) == $item->id ? 'selected="true"' : ''  }}>{{ $item->nama }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                <select class="form-control @error('akseptor_kb_id') is-invalid @enderror" name="akseptor_kb_id" id="akseptor_kb_id">
                                    ...
                                    @foreach ($akseptor_kb as $item)
                                        <option value="{{ $item->id }}" {{ old('akseptor_kb_id', $penduduk->akseptor_kb_id) == $item->id ? 'selected="true"' : ''  }}>{{ $item->nama }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                <select class="form-control @error('asuransi_id') is-invalid @enderror" name="asuransi_id" id="asuransi_id">
                                    ...
                                    @foreach ($asuransi as $item)
                                        <option value="{{ $item->id }}" {{ old('asuransi_id', $penduduk->asuransi_id) == $item->id ? 'selected="true"' : ''  }}>{{ $item->nama }}</option>
                                    @endforeach
                                </select>
    ...
    function option (value) {
        ...
        $.get(baseURL + "/akseptor-kb/" + value, function (response) {
            ...
            $.each(response, function (key, item){
                option += `<option value="${item.id}" ${"{{ old('akseptor_kb_id', $penduduk->akseptor_kb_id) }}" == item.id ? 'selected' : ''}>${item.nama}</option>`;
            });
